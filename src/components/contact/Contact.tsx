...
const Contact = () => {
  ...
  return (
    <div className="bg-[#2b2b2b] flex flex-col pt-[550px] pb-[460px] items-center justify-center px-4 sm:px-30 sm:py-6 sm:pt-40 w-full h-screen">
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-40">
        ...
        <form onSubmit={onSubmit} className="flex flex-col sm:gap-3 sm:w-[500px] border-b-8 border-amber-900 py-6 sm:pt-0">
          <div className="flex flex-col gap-4 sm:gap-3 text-amber-700">
            <label htmlFor="name" className="text-xl sm:text-3xl">Nombre</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-4 sm:gap-3 text-amber-700">
            <label htmlFor="email" className="text-xl sm:text-3xl pt-3">Email</label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-4 sm:gap-3 text-amber-700">
            <label htmlFor="message" className="text-xl sm:text-3xl pt-3">Mensaje</label>
            <textarea
              name="message"
      ...
      <div className="text-center text-xl text-amber-600 mt-4" aria-live="assertive">{status}</div>
    </div>
  );
};
