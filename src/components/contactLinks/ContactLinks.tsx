  ...
  return (
    <div className="flex flex-row items-center gap-3">
      <a href="https://wa.me/5493364621314" target="_blank">
        <FaWhatsapp size={35} className="text-[#3a3a3a] hover:text-amber-700" />
      </a>
      <a href="https://www.instagram.com/g357er7/" target="_blank">
        <FaInstagram size={35} className="text-[#3a3a3a] hover:text-amber-700" />
      </a>
      ...
      <a href="https://github.com/GerKoch" target="_blanck">
        <FaGithub size={35} className="text-[#3a3a3a] hover:text-amber-700" />
      </a>
      <a href="https://www.linkedin.com/in/germ%C3%A1n-koch-584548224/" target="_blank">
        <FaLinkedin size={35} className="text-[#3a3a3a] hover:text-amber-700" />
      </a>
    </div>
  )
}
